...
export const EditAnnouncementForm = ({ toggleShow, announcement }) => {
  const initialValues = {
  ...
  const [
    { isLoading, error },
    { editAnnouncement, getAnnouncementsByHouseCouncil, getTopAnnouncements },
  ] = useAnnouncements();
  const handleSubmit = ({ title, description }) => {
    editAnnouncement({ data: { title, description }, id: announcement._id })
      .unwrap()
      .then(() => {
        toggleShow(false);
